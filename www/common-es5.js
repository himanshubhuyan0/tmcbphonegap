    ...
    function srcAppServicesUserServiceServiceTs(module, __webpack_exports__, __webpack_require__) {
      ...
      var UserServiceService = /*#__PURE__*/function () {
        function UserServiceService(http) {
          ...
          this.http = http;
          this.getBaseUrl = 'http://assamgovjobs.com/shareholder/apis/v1/getapi';
          this.postBaseUrl = 'http://assamgovjobs.com/shareholder/apis/v1/postapi';
        }

        _createClass(UserServiceService, [{
          key: "getAllquestions",
          value: function getAllquestions() {
            var url = this.getBaseUrl + '?type=securityquestions';
          ...
          value: function loginUser(username, password) {
            var url = this.postBaseUrl + '?type=login&username=' + username + '&password=' + password;
            return this.http.get(url).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (res) {
              return res;
            }));
          }
          ...
          key: "verifyAccount",
          value: function verifyAccount(uId, ans1, ans2, qus1, qus2) {
            var url = this.postBaseUrl + '?type=verify&uid=' + uId + '&ans1=' + ans1 + '&ans2=' + ans2 + '&q1=' + qus1 + '&q2=' + qus2;
            return this.http.get(url).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (res) {
              return res;
            }));
          }
          ...
          value: function getAlluserDetails(uid) {
            var url = this.getBaseUrl + '?type=userdetails&uid=' + uid;
            return this.http.get(url).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (res) {
              return res;
            }));
          }
      ...
      UserServiceService = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])({
        providedIn: 'root'
      })], UserServiceService);
      /***/
    }
