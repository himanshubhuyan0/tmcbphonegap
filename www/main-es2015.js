...
const routes = [
    ...
    {
        path: 'verify',
        loadChildren: () => Promise.all(/*! import() | verify-verify-module */[__webpack_require__.e("common"), __webpack_require__.e("verify-verify-module")]).then(__webpack_require__.bind(null, /*! ./verify/verify.module */ "./src/app/verify/verify.module.ts")).then(m => m.VerifyPageModule)
    },
    {
        path: 'profile',
    ...
    {
        path: 'account',
        loadChildren: () => Promise.all(/*! import() | account-account-module */[__webpack_require__.e("common"), __webpack_require__.e("account-account-module")]).then(__webpack_require__.bind(null, /*! ./account/account.module */ "./src/app/account/account.module.ts")).then(m => m.AccountPageModule)
    }
];
...
let AppComponent = class AppComponent {
    constructor(platform, splashScreen, statusBar, storeService, router) {
...
let StorageService = class StorageService {
    ...
    getUserid() {
        return this.storage.getItem('uid').then(data => {
            if (data != null) {
                this.uId = data;
            }
            else {
    ...
    getVerify() {
        return this.storage.getItem('verify').then(data => {
            if (data != null) {
                this.verify = data;
            }
            else {
...
module.exports = __webpack_require__(/*! /var/www/mobileapp/tmcb/src/main.ts */"./src/main.ts");
