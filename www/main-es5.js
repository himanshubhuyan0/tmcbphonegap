  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
    ...
    function srcAppAppRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
      ...
      var routes = [{
        ...
        loadChildren: function loadChildren() {
          ...
          [__webpack_require__.e("common"), __webpack_require__.e("verify-verify-module")]).then(__webpack_require__.bind(null,
    ...
    function srcAppAppComponentTs(module, __webpack_exports__, __webpack_require__) {
      ...
      var AppComponent = /*#__PURE__*/function () {
        function AppComponent(platform, splashScreen, statusBar, storeService, router) {
          var _this = this;
          ...
          this.storeService.getVerify().then(function () {
            if (_this.storeService.verify > 0) {
              _this.router.navigate(['profile/tabs/tab1']);
            }
          });
        }
    ...
    function srcAppServicesStorageServiceTs(module, __webpack_exports__, __webpack_require__) {
      ...
      var StorageService = /*#__PURE__*/function () {
        ...
        _createClass(StorageService, [{
          key: "storeUserid",
          value: function storeUserid(uid) {
            return this.storage.setItem('uid', uid).then(function () {
          ...
          value: function getUserid() {
            ...
            return this.storage.getItem('uid').then(function (data) {
              if (data != null) {
                _this3.uId = data;
              } else {
                _this3.uId = -1;
          ...
          key: "storeVerify",
          value: function storeVerify() {
            return this.storage.setItem('verify', 1).then(function () {
          ...
          value: function getVerify() {
            ...
            return this.storage.getItem('verify').then(function (data) {
              if (data != null) {
                _this4.verify = data;
              } else {
                _this4.verify = -1;
    ...
    function _(module, exports, __webpack_require__) {
      ...
      /*! /var/www/mobileapp/tmcb/src/main.ts */
      "./src/main.ts");
      /***/
    }
  }, [[0, "runtime", "vendor"]]]);
